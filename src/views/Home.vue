  ...
  <el-row :gutter="20">
        ...
        <el-card class="box-card">
          <div class="user">
            ...
            <div class="userinfo">
              ...
              <p class="identity">
                {{ this.$store.state.userinfo.post | postFilter }}
              </p>
            </div>
          </div>
          <div class="login-info">
            ...
            <div class="time">
              <p>
                上次登录时间:<span>
                  {{ this.$store.state.userinfo.lastLogintime }}
                </span>
              </p>
            </div>
          </div>
        </el-card>
        <el-card class="box-card" style="height: 710px">
          ...
          <div>
            ...
            <el-pagination
              ...
              :current-page.sync="currentGoodDataPage"
              :page-size="5"
    ...
    <el-col :span="16">
      <div class="grid-content-bg-purple-light">
        <el-card class="box-card" style="height: 580px">
          ...
          <div>
            ...
            <el-pagination
              ...
              :current-page.sync="currentOrderDataPage"
              :page-size="5"
              layout="total, prev, pager, next"
              :total="orderTotal"
            >
        ...
        <el-card class="box-card">
          <div id="line-chart" style="width: 1000px; height: 355px"></div>
        </el-card>
      </div>
    </el-col>
  </el-row>
...
export default {
  ...
  created: function () {
    ...
    //历史记录
    axios
      .get("/api/orderGood/getShopHistory/" + this.currentOrderDataPage)
      .then((response) => {
    ...
    //今日记录
    axios
      .get("/api/good/getTodaySaleGood/" + this.currentGoodDataPage)
      .then((response) => {
